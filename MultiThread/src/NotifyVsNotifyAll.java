...
class Task implements Runnable {
  ...
  //这个显示不出来是因为并没有输出这个任务的语句，它和线程是不对应的
  
  public String toString() {
	    return "Entrance " + id + ": " ;
	  }
  //public String toString(){
	//  return getClass().getName() + "编号" + id + " ";
  //}
...
public class NotifyVsNotifyAll {
  public static void main(String[] args) throws Exception {
    ...
    timer.scheduleAtFixedRate(new TimerTask() {//这个后台程序将实现notify和notifyAll的替换执行
      boolean prod = true;
      public void run() {
        if(prod) {
          System.out.print("\nnotify() ");
